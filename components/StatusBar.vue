  ...
  <div class="flex items-center justify-between px-2 py-1">
    ...
    <div class="flex items-center gap-5">
      <div class="flex items-center gap-1.5">
        <span class="text-[10px] uppercase font-bold text-gray-500">相机</span>
        <Video :class="status.cameraConnected ? 'text-[#64C84C]' : 'text-red-500'" :size="16" fill="currentColor" />
      </div>
      <div class="flex items-center gap-1.5">
        <span class="text-[10px] uppercase font-bold text-gray-500">设备</span>
        <LayoutGrid :class="status.deviceConnected ? 'text-[#64C84C]' : 'text-red-500'" :size="16" fill="currentColor" />
      </div>
      <div class="flex items-center gap-1.5">
        <span class="text-[10px] uppercase font-bold text-gray-500">WES</span>
