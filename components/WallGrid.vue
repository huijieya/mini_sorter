...
<template>
  ...
  <div v-else :class="['flex flex-col relative', className]">
    <div class="mb-0.5 px-1">
      <span class="text-[8px] font-bold text-gray-500 uppercase tracking-widest">Wall: -</span>
    </div>
    <div class="flex-1 flex flex-col items-center justify-center border border-white/5 rounded-lg bg-black/10 overflow-hidden">
      <span class="text-[10px] font-bold text-gray-800 tracking-wider">OFFLINE</span>
    </div>
  </div>
</template>